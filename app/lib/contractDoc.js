  ...
  const articoliBlock = [
    ...
    new Paragraph({
      ...
      children: [
        ...
        new TextRun({ text: ' (di seguito "Utente") il posto barca ', size: 20 }),
        new TextRun({ text: berthLabel || '___', bold: true, size: 20 }),
        new TextRun({ text: ' (Categoria fino a Metri ', size: 20 }),
        new TextRun({ text: boat.length ? String(Math.ceil(Number(boat.length))) : '___', bold: true, size: 20 }),
        new TextRun({ text: ', pontile ', size: 20 }),
        new TextRun({ text: berthPontile, bold: true, size: 20 }),
        new TextRun({ text: ' lato ', size: 20 }),
        new TextRun({ text: berthLato, bold: true, size: 20 }),
        new TextRun({ text: ', posto N° ', size: 20 }),
