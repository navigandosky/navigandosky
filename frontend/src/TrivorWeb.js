...
const TrivorWebLogin = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
      <a href="#/suite" className="absolute top-6 left-6 flex items-center space-x-2 text-purple-300 hover:text-white transition-colors">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center space-x-3 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-2xl mb-4">
            ...
            <div className="text-left">
              <p className="text-xs text-purple-300 font-medium tracking-wider">OFFICE TRIVOR</p>
              <h1 className="text-2xl font-bold text-white">TRIVORWEB</h1>
            </div>
          </div>
          <p className="text-purple-200/70 text-sm">Gestione Siti Web & Hosting</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-semibold rounded-xl transition-all transform hover:scale-[1.02] disabled:opacity-50"
            >
              {loading ? (
